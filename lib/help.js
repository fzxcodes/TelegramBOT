...
const config = JSON.parse(fs.readFileSync(`./seting.json`))
...
exports.help = async(lol, name, user_id) => {
    text = `Halo ${name}, selamat datang di bot! *tanggal*\nDate: ${ini_hari}\nTime: ${time}\nPilih salah satu di bawah ini\n Semoga Hari Mu Menyenangkan`
    options = {
        reply_markup: {
            inline_keyboard: [
                [
                ...
                [ 
                    ...
                    { text: 'About User MENU', callback_data: 'user-' + user_id },
                ], 
                [
                    { text: 'Owner MENU', callback_data: 'owner-' + user_id },
                ], 
                [
